...
<link rel="stylesheet" type="text/css" href="${path}/resources/nosion/css/signin.css">
...
<body>
  ...
  <form class="SignInForm  gy-2" action="NE_Login.do" method="post" onsubmit="CheckLogin()">
	...
	<img src="${path}/resources/nosion/image/kakao_login_medium_narrow.png" onclick="kakaoLogin()">
    </div>
...
<script src="${path}/resources/nosion/js/SignIn.js"></script>
<script>
